    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-6 text-white">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-4">
                  <div
                    className={`w-16 h-16 rounded-full bg-gradient-to-br ${getStatusColor(dashboardPrefs.robotStatus)} flex items-center justify-center shadow-lg`}
                  >
                  ...
                  <div>
                    ...
                    <Badge
                      className={`bg-gradient-to-r ${getStatusColor(dashboardPrefs.robotStatus)} text-white border-0`}
                    >
                ...
                <div className="bg-white/5 rounded-2xl p-4 border border-white/10">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <span className="text-blue-400 text-sm font-mono">
                      {robotData.taskProgress.toFixed(1)}%
                    </span>
                  </div>
                  <p className="text-white font-medium mb-3">
                    {robotData.currentTask}
                  </p>
                  <Progress
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 mb-8">
        {sensorData.map((sensor, index) => (
          <Card
            key={sensor.name}
            className="bg-white/5 backdrop-blur-xl border border-white/10 p-4 shadow-xl hover:bg-white/10 transition-all duration-300"
          >
            <div className="flex items-center justify-between mb-3">
