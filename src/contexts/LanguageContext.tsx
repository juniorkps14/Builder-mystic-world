...
const translations = {
  en: {
    ...
    "sequence.noSequences": "No Sequences Yet",
  ...
  th: {
    ...
    "sequence.noSequences": "ยังไม่มีลำดับงาน",
    ...
    "map.mapCreatedSuccessfully": "ส���้างแผนที่เรียบร้อยแล้ว",
    ...
    "rviz.addNewDisplay": "เพ���่มการแสดงผลใหม่",
