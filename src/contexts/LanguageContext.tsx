...
const translations = {
  ...
  th: {
    ...
    "task.retries": "จำนวนล��งใหม่สูงสุด",
    ...
    "movement.dataLogging": "การบ���นทึกข้อมูล",
    ...
    "pattern.patternRepeat": "ทำซ้ำรูป��บบ",
    ...
    "map.subtitle":
      "สร้าง จัดการ และดูแผนที่จากระบบ ROS พร้อมการอัปเดตแ���บเรียลไทม์",
    ...
    "map.mapDeletedSuccessfully": "ลบแผ��ที่เรียบร้อยแล้ว",
